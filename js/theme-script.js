...
/*------------------------------- Slider ---------------------------------------*/
   ...
   $(function(){
       ...
       $('#sprdct-image1').slick({
           ...
           fade: true,
           autoplay: false,
           asNavFor: '#sprdct-thumb1'
       });
       $('#sprdct-thumb1').slick({
           slidesToShow: 4,
           slidesToScroll: 1,
           asNavFor: '#sprdct-image1',
           dots: false,
           centerMode: false,
           focusOnSelect: true,
           arrows: true,
       ...
       $('#sprdct-image2').slick({
           ...
           fade: true,
           autoplay: false,
           asNavFor: '#sprdct-thumb2'
       });

       $('#sprdct-thumb2').slick({
           slidesToShow: 4,
           slidesToScroll: 1,
           asNavFor: '#sprdct-image2',
           dots: false,
           centerMode: false,
           focusOnSelect: true,
           arrows: true,
       ...
       $('#sprdct-image3').slick({
           ...
           fade: true,
           autoplay: false,
           asNavFor: '#sprdct-thumb3'
       });
       
       $('#sprdct-thumb3').slick({
           slidesToShow: 4,
           slidesToScroll: 1,
           asNavFor: '#sprdct-image3',
           dots: false,
           centerMode: false,
           focusOnSelect: true,
           arrows: true,
       ...
       $('#sprdct-image4').slick({
           ...
           fade: true,
           autoplay: false,
           asNavFor: '#sprdct-thumb4'
       });
       
       $('#sprdct-thumb4').slick({
           slidesToShow: 4,
           slidesToScroll: 1,
           asNavFor: '#sprdct-image4',
           dots: false,
           centerMode: false,
           focusOnSelect: true,
           arrows: true,
       ...
       $('#sprdct-image5').slick({
           ...
           fade: true,
           autoplay: false,
           asNavFor: '#sprdct-thumb5'
       });
       
       $('#sprdct-thumb5').slick({
           slidesToShow: 4,
           slidesToScroll: 1,
           asNavFor: '#sprdct-image5',
           dots: false,
           centerMode: false,
           focusOnSelect: true,
           arrows: true,
       ...
       $('#sprdct-image6').slick({
           ...
           fade: true,
           autoplay: false,
           asNavFor: '#sprdct-thumb6'
       });
       
       $('#sprdct-thumb6').slick({
           slidesToShow: 4,
           slidesToScroll: 1,
           asNavFor: '#sprdct-image6',
           dots: false,
           centerMode: false,
           focusOnSelect: true,
           arrows: true,
